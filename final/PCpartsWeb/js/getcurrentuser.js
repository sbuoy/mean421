          ...
          if(window.location.href.split("/").slice(-1) == "account.html") {
            ...
            accountInfo = `
             <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="acc-first-name" class="form-control here"type="text" value="${result[5].getValue()}">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="account" class="col-4 col-form-label">Last Name</label> 
                                <div class="col-8">
                                  <input id="acc-last-name" class="form-control here"type="text" value="${result[6].getValue()}">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="account" class="col-4 col-form-label">Street Address</label> 
                                <div class="col-8">
                                  <input id="acc-Streetaddress" class="form-control here"type="text" value="${fulladdress[0]}">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="account" class="col-4 col-form-label">City</label> 
                                <div class="col-8">
                                  <input id="acc-City" class="form-control here"type="text" value="${fulladdress[1]}">
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="acc-State"class="form-control here" type="text" value="${fulladdress[2]}">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="account" class="col-4 col-form-label">Zipcode</label> 
                                <div class="col-8">
                                  <input id="acc-Zipcode" class="form-control here"  type="text" value="${fulladdress[3]}">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="account" class="col-4 col-form-label">Country</label> 
                                <div class="col-8">
                                  <input id="acc-Country" class="form-control here" type="text" value="${fulladdress[4]}">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="account" class="col-4 col-form-label">Phone Number</label> 
                                <div class="col-8">
                                  <input id="acc-phone" class="form-control here" type="text" value="${fphonenumber[1]}">
                                </div>
                              </div> 
                                 <div class="form-group row">
                                <label for="account" class="col-4 col-form-label">Email</label> 
                                <div class="col-8">
                                  <input id="acc-email" class="form-control here" type="text" value="${result[7].getValue()}">
                                </div>
                              </div> 
                              <div class="form-group row">
                                <div class="offset-4 col-8">
                                 <input id="updateUser" type="button" class="btn btn-lg btn-success" value="Update" onclick="addAttributes();">
                                </div>
                              </div>
  ...
  try {
    if (cognitoUser != null) {
      ...
      var userinfo = cognitoUser.getUserAttributes(function (err, result) {
        ...
        var API ="https://u81eogk9y0.execute-api.us-east-1.amazonaws.com/New/sales?TableName=Sales_Order421";
        var JSONObject ={}
        try {
